        ...
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
                <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
                    {currentGeo && (
                        <code className="font-mono font-bold w-100">
                            {currentGeo.coords.latitude}, {currentGeo.coords.longitude}
                        </code>
                    )}
                </p>
            ...
            {isAppInstalled && (
                <button className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
                    <h2 className={`mb-3 text-2xl font-semibold`}>
                        Installed <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">✔</span>
                    </h2>
                    <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Service worker is registered.</p>
                </button>
            )}
            ...
            <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-4 lg:text-left">
                {!isPwaSupported && (
                    <button className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
                        <h2 className={`mb-3 text-2xl font-semibold`}>
                            Installed <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">✖️</span>
                        </h2>
                        <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Install this page as an app to get started</p>
                    </button>
                )}
                ...
                {!isPushGranted && (
                    <button
                        ...
                        <h2 className={`mb-3 text-2xl font-semibold`}>
                            Push <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">✖️</span>
                        </h2>
                        <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Enable Push Notifications</p>
                    </button>
                )}
                ...
                {isAppInstalled && isPushGranted && (
                    <button
                        ...
                        <h2 className={`mb-3 text-2xl font-semibold`}>
                            Push <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">✔</span>
                        </h2>
                        <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Test Push Notifications</p>
                    </button>
                )}
                ...
                {isAppInstalled && isPushGranted && (
                    <button
                        ...
                        <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Clear Badge Counter</p>
                    </button>
                )}

                {isAppInstalled && isGeoSupported() && (
                    <button
                        className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
                        onClick={() => requestCurrentPosition()}>
                        <h2 className={`mb-3 text-2xl font-semibold`}>
                            Location <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">✔</span>
                        </h2>
                        <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Get current coordinates.</p>
                    </button>
                )}

                {isAppInstalled && isStorageSupported() && (
                    <button
                        className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
                        onClick={() => getServiceStorage()}>
                        <h2 className={`mb-3 text-2xl font-semibold`}>
                            Storage <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">✔</span>
                        </h2>
                        <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>Reveal a storage entry.</p>
                    </button>
                )}
            </div>
        </main>
