    ...
    const requestPermission = () => {
        if ("Notification" in window) {
            if (typeof window === "undefined" || !messaging) {
                console.log("This broswer does not support notifications.");
                return;
            }
                            ...
                            {!canNotify ? (
                                <span className="" onClick={requestPermission}>
                                    <TooltipProvider>
                                        <Tooltip>
                                            <TooltipTrigger>
                                                <svg className="" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#827d7d" viewBox="0 0 256 256">
                                                    <path
                                            ...
                                            {permissionState === "default" ? (
                                                ...
                                                <TooltipContent className="flex items-center gap-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#d80e0e" viewBox="0 0 256 256">
                                                        <path d="M224,128a96,96,0,1,1-96-96A96,96,0,0,1,224,128Z" opacity="0.2"></path>
                                                        <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm-8-80V80a8,8,0,0,1,16,0v56a8,8,0,0,1-16,0Zm20,36a12,12,0,1,1-12-12A12,12,0,0,1,140,172Z"></path>
                                                    </svg>
                                                    <p className="text-red-500">Browser Notifications have been blocked</p>
                                                </TooltipContent>
                                            )}
                                        </Tooltip>
                                    </TooltipProvider>
