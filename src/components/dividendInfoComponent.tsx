    ...
    return (
      <div className="border rounded-2xl shadow-lg py-4 px-6 w-fit mx-auto my-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <span className="text-blue-700">{dividendinfo[0]?.date}</span>
        </div>
        <div className="flex flex-col sm:flex-row">
          Amount per share:{" "}
        ...
        <div className="flex flex-col sm:flex-row">
          Dividend frequency:{" "}
          <span className="text-blue-700">{dividendinfo[0]?.frequency}</span>
        </div>
        <div className="flex flex-col sm:flex-row">
          You must hold shares before:{" "}
          <span className="text-blue-700">{dividendinfo[0]?.recordDate}</span>
        </div>
      </div>
    );
  } else {
